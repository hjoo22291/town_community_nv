...
$(document).ready(function() {
    ...
    websocket.onmessage = function(event) {
        ...
        if (sender == user) {
	        ...
	        messageReceived.html('<div class="sendername">' + sender + '</div><div class="bubble">' + message + '</div><div class="combobox"><ul><li>신고하기</li></ul></div>');
    ...
    $('.combobox').click(function() {
    	window.open('/reportForm_gchat','_blank', 'width=500,height=400');
    })
});
