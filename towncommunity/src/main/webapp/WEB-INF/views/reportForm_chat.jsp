		...
		e.preventDefault();
 		let isChecked = $("input:radio[name=report_reason]").is(":checked");
  		if(isChecked){
  			...
  			var message_id = '${dto.message_id }';
  			var reported_member_id = '${dto.member_id }';
  			var reported_contents = '${dto.message_content }';
  			var reporter =  '${dto.touser_id}';
  			alert(message_id +" / "+ reported_member_id +" / "+ reporter);
  			/* $.ajax({
 				url : 'reportChat',
 				type : 'post',
 				data : {
 					'message_id' : "${dto.message_id }",
 					'reported_member_id' : "${dto.member_id }",
 					'reported_contents' : '${dto.message_content }',
 					'reporter' : "${member_id}",
...
<div id="form-wrap">
	...
	<input type="hidden" id="message_content" value="${dto.message_content}">
